...
<div class="container">
    <div class="row">
        <div class="col-12 py-3">
            <h3 class="text-center">Month Expenses Dashboard</h3>
        </div>
...
<table class="table table-bordered table-striped table-hover">
  ...
  <tbody>
    ...
    $fetch_expense = "SELECT * FROM `expense_info` WHERE `item_date` BETWEEN '$previous_month_date' AND '$today_date' ORDER BY `item_date` DESC";
